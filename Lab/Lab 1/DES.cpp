...
// function for Oberver and Arrival Events 
...
void simulateMM1Queue() {
	...
	for (double rho = 0.25; rho <= 1.05; rho += 0.1) {
		lambda = (1.2 * C)/L;
		alpha = 5 * lambda;
	...
	cout << "Done simulating MM1 Queue!\n";
}


// M/M/M/1/K Simulation 
 ...
 * Comment the simulation you are not running
 */
int main() {
	 simulateMM1Queue();
	//simulateMM1KQueue();
